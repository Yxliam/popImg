...
;(function($, window, undefined) {
  ...
  PopImg.prototype = {
    ...
    bindClick:function(){
      var _this = this;
      $(this.body).on('touchend','.yxl-zoom',function(e){
         e.preventDefault();
         var target   = e.target;
    ...
    slideHandle:function(e){
        var self = this;
        touch.on('.'+self.zoomImg,'swipeleft',function(e){
            self.slideLeft();
        })
        touch.on('.'+self.zoomImg,'swiperight',function(e){
            self.slideRight();
        })
        touch.on('.'+self.zoomImg,'tap',function(e){
            self.closePop();
        })  
    },
    closePop:function(){
